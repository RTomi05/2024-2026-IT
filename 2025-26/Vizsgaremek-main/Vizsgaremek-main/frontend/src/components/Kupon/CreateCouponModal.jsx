...
import { createKupon } from '../../services/kuponService.js';
...
export default function CreateCouponModal({ onClose, onCreated }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res.success) {
        ...
        setGlobalError(res.message || 'Hiba a kupon létrehozásakor.');
      }
    } catch {
  ...
  return (
    <div className="cm-overlay" onClick={e => e.target === e.currentTarget && onClose()}>
      <div className="cm-modal" role="dialog" aria-modal="true" aria-labelledby="create-modal-title">
        <div className="cm-modal-header">
          <h2 id="create-modal-title" className="cm-modal-title">
        ...
        <form onSubmit={handleSubmit} className="cm-modal-body" noValidate>
          <div className="cm-form-row cm-form-row--2">
            <div className="form-group">
              <label className="form-label" htmlFor="create-kod">
            ...
            <div className="form-group">
              <label className="form-label" htmlFor="create-kedvezmeny">
                Kedvezmény <span className="cm-required">*</span>
              </label>
              <input
                id="create-kedvezmeny"
                name="kedvezmeny"
                type="text"
                className={`form-control${errors.kedvezmeny ? ' is-invalid' : ''}`}
                placeholder="pl. 20% vagy 500 Ft"
          ...
          <div className="cm-form-row cm-form-row--2">
            <div className="form-group">
              <label className="form-label" htmlFor="create-kezdesi">
            ...
            <div className="form-group">
              <label className="form-label" htmlFor="create-lejarasi">
          ...
          <div className="form-group">
            <label className="form-label" htmlFor="create-hely">
            ...
            <input
              ...
              placeholder="pl. Minden boltban vagy Online"
          ...
          <div className="form-group">
            <label className="form-label" htmlFor="create-megjegyzes">
              Megjegyzés <span className="cm-optional">(opcionális)</span>
            </label>
            <textarea
              id="create-megjegyzes"
              name="megjegyzes"
              className="form-control"
              placeholder="További leírás a kuponról..."
          ...
          <div className="cm-modal-footer">
            ...
            <button type="submit" className="btn btn-primary" disabled={loading}>
              {loading ? <><span className="spinner-sm" /> Létrehozás...</> : 'Kupon létrehozása'}
            </button>
          </div>
        </form>
      </div>
